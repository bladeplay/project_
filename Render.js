...
Renderer.prototype.lockPointer = function()
{
	...
	// firefox can only lock pointer when in full screen mode, this game should never run in full screen
	if('mozPointerLockElement' in document)
	{
		alert("Firefox needs full screen to lock mouse. Use Chrome or Opera for the time being.");
		return;
	}
